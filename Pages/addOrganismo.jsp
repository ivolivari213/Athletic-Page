...
<%
	...
	try{
			...
			boolean res=appDBAuth.addOrganismo( Pueblo_idPueblo,organizacionNombre,organizacionRegistroDptoEstado,organizacionTelefono,organizacionDireccionFisica,organizacionCorreoElectronico,organizacionPaginaWeb,organizacionDireccionPostal,organizacionReglamentoUrl);%>
