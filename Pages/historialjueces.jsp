...
//variables para guardar los query
...
<html>
	...
	<body>
		<form id="form_1" action="historialjueces2.jsp" method="post">
			<%
				...
				//Call the historialjueces method.

				 resultset=appDBAuth.historialjueces();
				%>
				<%
    ...
    <table border="0" id="ex-table">
  	...
  	<td> Seleccione un juez: </td>

  				 <td> <select  name="juez">
//dropdown de los jueces
