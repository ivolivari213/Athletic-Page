...
<html>
	...
	<body>
		<form id="form_1" action="addVestimenta1.jsp" method="post">
			<%
			...
			//Call the listVestimenta method
			 resultset=appDBAuth.listVestimenta();
      ...
      //campos para llenar con la informacion que pide
			...
			<td> Atleta: </td>
				...
				<tr>
				<td> Vestimenta: </td>
							 <td> <select required name="idVestimenta"   multiple>
               //dropdown de vestimentas
					...
					<tr>
						...
						<td><input type="date"size="12" maxlength="10" id="fecha"  name="fecha" required />
					</tr>
	        <tr>
			</table>
