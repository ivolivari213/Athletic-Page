...
public class MySQLCompleteConnector{
	...
	private String DB_URL="jdbc:mysql://localhost/proyecto2";
	...
	/***********
		doSelectDistinct method
			...
			@returns:
				ResulSet result containing the project tuples resulting from the query
	*/
	public ResultSet doSelectDistinct(String fields, String tables, String where ){

		//Create a ResulSet
		ResultSet result=null;

		//Create the selection statement
		String selectionStatement = "Select Distinct "  + fields + " from " + tables + " where " + where + ";";
	...
	/***********
		doSelectMax method
			...
			@returns:
				ResulSet result containing the project tuples resulting from the query
	*/
	public ResultSet doSelectMax(String field, String table){
		//Create a ResulSet
		ResultSet result=null;

		//Create the selection statement
		String selectionStatement = "Select max("+ field +")+1"+ " from " + table + ";";
		System.out.println(selectionStatement);
	...
	/***********
		doSelectMax1 method
			...
			@returns:
				ResulSet result containing the project tuples resulting from the query
	*/
	public ResultSet doSelectMax1(String field, String table){
		//Create a ResulSet
		ResultSet result=null;

		//Create the selection statement
		String selectionStatement = "Select max("+ field +")"+ " from " + table + ";";
		System.out.println(selectionStatement);
	...
	/***********
		doSelectMaxed method
			...
			@returns:
				ResulSet result containing the project tuples resulting from the query
	*/
	public ResultSet doSelectMaxed(String field, String field1, String table   ){
		//Create a ResulSet
		ResultSet result=null;

		//Create the selection statement
		String selectionStatement = "Select max("+ field +"), "+ field1+ " from " + table + " where " +field+"=(Select max("+field+") from "+table+") ;";
		System.out.println(selectionStatement);
