...
public class LigasDirect extends AppCompatActivity  {

    //This is for debugging
    private String TAG = LigasDirect.class.getSimpleName();
    ...
    private class GetItems extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(LigasDirect.this, "Items list is downloading", Toast.LENGTH_LONG).show();
        }
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < items.length(); i++) {
                        ...
                        String organizacionDireccionPostal = c.getString("organizacionDireccionPostal");
                        ...
                        itemUserList.add(new userItem(personaNombres, personaApellidos,posicionNombre,organizacionNombre,
                                puebloNombre,organizacionRegistroDptoEstado,organizacionTelefono,organizacionDireccionFisica,
                                organizacionDireccionPostal,organizacionCorreoElectronico,organizacionPaginaWeb,organizacionReglamentoUrl));
                    }
    ...
    public class UsersAdapter extends ArrayAdapter<userItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_ligas_direct, parent, false);
            }
            ...
            TextView organizacionDireccionPostal = (TextView) convertView.findViewById(R.id.organizacionDireccionPostal);
            ...
            itemName.setText(user.personaNombres);
            itemPrice.setText(user.personaApellidos);
            ...
            organizacionDireccionPostal.setText(user.organizacionDireccionPostal);
    ...
    public class userItem {
        ...
        public String organizacionDireccionPostal;
         ...
         */
        public userItem(String personaNombres, String  personaApellidos, String posicionNombre,String organizacionNombre,String puebloNombre,
                        String organizacionRegistroDptoEstado,String organizacionTelefono,String organizacionDireccionFisica,
                        String organizacionDireccionPostal,String organizacionCorreoElectronico,String organizacionPaginaWeb,String organizacionReglamentoUrl) {
            ...
            this.organizacionDireccionPostal = organizacionDireccionPostal;
